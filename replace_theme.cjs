...
// Replacements
content = content.replace(/dark:bg-\[\#0a0a0c\]/g, 'dark:bg-[#09090b]');
content = content.replace(/dark:bg-black/g, 'dark:bg-[#09090b]');
content = content.replace(/dark:bg-\[\#121214\]/g, 'dark:bg-white\/5');
